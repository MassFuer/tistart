        ...
        >
          ...
          <video
            ...
            onPlay={() => {
              ...
              // Track Play
              if (!hasPlayed && artwork?._id) {
                artworksAPI
                  .incrementPlay(artwork._id)
          ...
          {/* Controls Overlay */}
          <div
            className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent px-4 py-4 transition-opacity duration-300 ${showControls ? "opacity-100" : "opacity-0"}`}
          >
            {/* Progress Bar */}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {accessInfo?.purchasedAt && (
                  <Badge
                    variant="outline"
                    className="text-white border-white/30 bg-white/10 text-[10px] h-5"
                  >
                    Purchased
                  </Badge>
                )}
          ...
          <div className="absolute bottom-12 right-4 z-20">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  size="sm"
                  className="shadow-xl font-bold bg-amber-500 hover:bg-amber-600 text-black border-0"
                >
              ...
              <AlertDialogContent className="z-[100]">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    You are watching a short preview. To watch the full version
                    of <strong>{artwork.title}</strong>, you can add it to your
                    library for{" "}
                    <strong>{Number(artwork.price).toFixed(2)} €</strong>.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
    ...
    <div className="w-full">
      <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden group">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${video.thumbnailUrl || artwork.images?.[0]})`,
          }}
        />
            ...
            {accessInfo?.requiresLogin ? (
              <>
                <p className="text-white/80 mb-6">
                  Log in to watch or purchase this video.
                </p>
              ...
              <>
                <div className="mb-6">
                  ...
                  <p className="text-sm text-white/70">
                    One-time purchase • Unlimited streaming
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 w-full">
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button
                        size="lg"
                        className="w-full font-semibold box-shadow-xl"
                      >
                        Unlock Now
                      </Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          You are about to add <strong>{artwork.title}</strong>{" "}
                          to your cart for{" "}
                          <strong>{Number(artwork.price).toFixed(2)} €</strong>.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
