          ...
          <div className="flex-1 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your selection before checkout
                </CardDescription>
              </CardHeader>
                ...
                {cart.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex flex-col sm:flex-row gap-4 p-6 hover:bg-muted/20 transition-colors"
                    >
                      {/* Image */}
                      <Link
                        to={
                        ...
                        className="shrink-0 w-full sm:w-32 aspect-square rounded-md overflow-hidden bg-muted border relative"
                      >
                              ...
                              disabled={
                                ...
                                (isTicket
                                  ? product.maxCapacity > 0
                                    ? Math.min(3, product.maxCapacity)
                                    : 3
                                  : product.totalInStock || 1)
                              }
                            >
