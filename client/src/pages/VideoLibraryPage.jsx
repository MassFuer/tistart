...
const VideoLibraryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white dark">
      ...
      <div className="bg-black border-b border-white/10 py-4 mb-8">
          <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                  ...
                  <p className="text-neutral-400">
                      Explore our collection of {pagination.total || 0} video artworks
                  </p>
              </div>
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-8 relative items-start">
          {/* DESKTOP SIDEBAR */}
          <FilterAside>
                  ...
                  <Loading />
                   ...
                   <>
                       ...
                       <div className="mt-12 flex items-center justify-between">
                           ...
                           />
                           {/* Pagination might need dark mode styles if it uses standard buttons without dark class context properly */}
                           <div className="dark text-white">
                                <Pagination
