...
const ArtworkDetailPage = () => {
  ...
  return (
    <div className="container mx-auto px-0 sm:px-4 lg:px-8 py-4 sm:py-8 max-w-7xl animate-in fade-in duration-500 overflow-x-hidden">
      <Button
        variant="ghost"
        className="mb-4 sm:mb-6 mx-4 sm:mx-0 pl-0 hover:bg-transparent hover:text-primary"
        asChild
      >
            ...
            <div className="relative aspect-square sm:aspect-[4/3] w-full sm:rounded-xl overflow-hidden bg-muted/20 sm:border shadow-sm">
              {artwork.video?.url ? (
                <div className="w-full h-full relative group">
                  ...
                  <VideoPlayer
                    artwork={artwork}
                    onPurchaseComplete={fetchArtwork}
                  />
        ...
        <div className="space-y-6 px-4 sm:px-0">
          <div>
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {artwork.video?.url && (
                <Badge
                  variant={artwork.video.isPaid ? "default" : "outline"}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-end gap-3">
                ...
                {artwork.isForSale &&
                  ...
                  artwork.price < artwork.originalPrice && (
              ...
              <div className="flex gap-2">
                ...
                {(artwork.category === "video" ||
                  artwork.category === "music") && (
                  <Button
                    variant="secondary"
                    size="icon"
                    title="Watch in Immersive Mode"
                ...
                {artwork.materialsUsed?.length > 0 && (
                  <div className="bg-muted/30 p-3 rounded-lg border">
                    ...
                    <p
                      ...
                      title={artwork.materialsUsed.join(", ")}
                    >
          ...
          <div className="flex flex-col gap-4">
            {isAuthenticated && (isAdmin || isOwner) ? (
              ...
              <div className="w-full">
                {artwork.isForSale && <AddToCartButton artwork={artwork} />}
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-center text-xs text-muted-foreground gap-2">
            ...
            <span>
              {artwork.totalInStock > 0
                ? `${artwork.totalInStock} units in stock`
